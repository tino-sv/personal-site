         ...
         <div className="flex flex-col min-h-screen p-8 max-w-3xl mx-auto">
            ...
            <main className="flex-grow space-y-12">
               ...
               <section className="space-y-4">
                  ...
                  <a
                     href="https://kikido.vercel.app/"
                     target="_blank"
                     rel="noopener noreferrer"
                  >
                     <h3 className="text-red-400/90 mt-4 underline">
                        ToDo.dev
                     </h3>
                  </a>
                  <p className="text-sm max-w-md">
                     typescript-powered todo app with a blog built with vite,
                     react, vercel, tailwind, and supabase
                  </p>
                  ...
                  <section className="space-y-4">
                     ...
                     <section className="space-y-4">
                        <h3 className="text-red-400/90 mt-4 underline">
                           unnamed Golang terminal project
                        </h3>
                        <p className="text-sm max-w-md">
